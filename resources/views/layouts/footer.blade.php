    ...
    <div class="grid grid-cols-2 gap-8 px-6 py-8 md:grid-cols-4">
        <div class="px-4">
            ...
            <ul class="text-gray-300">
                ...
                <li class="mb-2">
                    <h3 href="#">Kec. Baturraden, Banyumas, Jawa Tengah 53151</h3>
                </li>
                <li class="mb-4">
                    <h3 href="#">laeka.boomy@gmail.com</h3>
                </li>
            </ul>
        </div>
        <div class="py-8">
            <h2 class="mb-6 text-sm font-semibold text-gray-100 uppercase">Menu</h2>
            <ul class="text-gray-300">
                <li class="mb-4">
        ...
        <div class="py-8">
            <h2 class="mb-6 text-sm font-semibold text-gray-100 uppercase">Hubungi Kami</h2>
            <div class="mt-3 flex items-center justify-start">
                <a href="https://www.instagram.com/teraskayu_pwt" target="_blank"
                    class="mr-3 flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 text-slate-300 hover:border-purple-700 hover:bg-purple-700 hover:text-white">
                ...
                <a href="https://" target="_blank"
                    class="mr-3 flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 text-slate-300 hover:border-green-700 hover:bg-green-700 hover:text-white">
                    <img src="https://img.icons8.com/ios/50/ffffff/whatsapp--v1.png" alt="whatsapp--v1" role="img"
